...
dream_a *create_dream(wininf *inf)
{
    ...
    dream->b_dream[0] = c_eles("dreams_1.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 882 / 3, 384});
    dream->b_dream[0].resize = (sfVector2f) {6.530612245, 5.625};
    dream->b_dream[1] = c_eles("dreams_1.png", (sfVector2f) {0, 0},
    (sfIntRect) {882 / 3, 0, 882 / 3, 384});
    dream->b_dream[1].resize = (sfVector2f) {6.530612245, 5.625};
    dream->b_dream[2] = c_eles("dreams_1.png", (sfVector2f) {0, 0},
    (sfIntRect) {882 / 3 + 882 / 3, 192, 882 / 3, 384});
